test_that("NSAF_function calculates the correct index for a single dataset", {
  ...
  result <- NSAF_function(samples, length_proteins)
...
test_that("NSAF_function calculates the correct index for a list of groups", {
  length_proteins <- c(300, 500, 200)
  group1 <- matrix(
    c(5, 10, 15,
      20, 25, 30),
  ...
  result <- NSAF_function(list(group1, group2), length_proteins)
...
test_that("NSAF_function works with different numbers of samples and proteins", {
  length_proteins <- c(300, 500, 200)
  samples <- matrix(
    c(10, 20, 30,
      40, 50, 60),
