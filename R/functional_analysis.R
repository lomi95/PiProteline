...
#'
#' }
functional_analysis <- function(LDA_pairw.results, Unweighted_CN, Weighted_CN, names_of_groups, tax_ID, categories){

  summaryTable <- summary_table(LDA_pairw.results = LDA_pairw.results,
